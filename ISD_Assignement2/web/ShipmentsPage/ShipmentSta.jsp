...
<html>
    ...
    <body>
        ...
        <br/>
        <div class="pc_cb">
            <p class="pc_cb_tit">Please Type in Shipment ID and status that needs to be update</p>
            <form action="../UpdateStaServlet" method="post">
                <input class="pc_ud_input" style="width: 100px" name="shipmentID" placeholder="ShipmentID" required="true">
                <input class="pc_ud_input" style="width: 200px" name="Status" placeholder="Status:ture or false" required="true">
