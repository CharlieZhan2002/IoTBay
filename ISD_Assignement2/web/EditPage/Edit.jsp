...
<div class="lg_cb">
    ...
    <form action="../EditServlet" method="post">
        ...
        <input class="lg_cb_ip" type="text" placeholder="${email}" name="email" required="true" readonly="readonly">

        <p class="lg_cb_iptit">Real Full Name</p>
        <input class="lg_cb_ip" type="text" placeholder="${name}" name="name" required="true">

        <p class="lg_cb_iptit">Password</p>
        <input class="lg_cb_ip" type="text" placeholder="${password}"name="password" required="true">

        <p class="lg_cb_iptit">Date of Birthday</p>
        <input class="lg_cb_ip" type="text" placeholder="${dob}"name="dob" required="true">
        ...
        <br/>
        <br/>
        <a class="lg_cb_su" href="../MainPage/Main.jsp">Cancel</a>
        <br/>
